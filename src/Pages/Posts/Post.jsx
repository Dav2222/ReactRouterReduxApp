...
const Post = (props) => {
  ...
  const  fetchData = async (postId) => {
     const post_req = await fetch(`https://jsonplaceholder.typicode.com/posts/${postId}`)
      ...
      const com_req = await fetch(`https://jsonplaceholder.typicode.com/posts/${postId}/comments`)
